	...
	<form id ="passwordCnfirm" action="/member/findPasswordComplete.do" method="post" onsubmit="return checkForm(this)">
		<fieldset>
			...
			<div class="change_intro">
				...
				<p>
				쉬운 비밀번호나 자주 쓰는 사이트의 비밀번호 같은 경우, 도용되기 쉬워 주기적으로 변경하여 사용하는 것이 좋습니다.</br>
			...
			<div class="change_inp">
				<div>
					...
					<span>비밀번호는 영문, 숫자, 특수문자 등 3가지 사용 시 8자 이상, 2가지 사용 시 10자리 이상으로 구성하여 주십시오.</span>
				</div>
				<div>
					<label for="password2">새 비밀번호 확인</label>
					<input type="password" id="password2" name="password2" class="inp" />
				</div>
			</div>
			<div class="btn-cont"> 
